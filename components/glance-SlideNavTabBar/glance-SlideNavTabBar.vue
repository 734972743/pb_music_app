...
<template name="glance-SlideNavTabBar">
	<!-- 预留间隙 顶吸控制-->
	<view style="padding: 10px 0 5px 0; position: -webkit-sticky;" :style="{top: topfixedval ,position: positionS ,background: bgcolor}">
	<view style="background-color: inherit; margin: 0 0px 5px 0px;" >
		<!-- 横向滚动菜单 -->
...
<style lang="scss">
	.glance-slidenav-tabbar{height: 60upx;display: inline-block;display: flex;z-index: 1;
		&-item{height: 45upx; min-height: 45upx; margin-left: 40upx;
